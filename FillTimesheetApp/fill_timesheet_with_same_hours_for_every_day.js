...
module.exports = {
    ...
    //set hours
            .type('input[id="tcPage:tcForm:tcBlock:tcPbs:j_id74:0:sunTime"]',"\b\b\b\b"+hours)
            .type('input[id="tcPage:tcForm:tcBlock:tcPbs:j_id74:0:monTime"]',"\b\b\b\b"+hours)
            .type('input[id="tcPage:tcForm:tcBlock:tcPbs:j_id74:0:tuesTime"]',"\b\b\b\b"+hours)
            .type('input[id="tcPage:tcForm:tcBlock:tcPbs:j_id74:0:wedTime"]',"\b\b\b\b"+hours)
            .type('input[id="tcPage:tcForm:tcBlock:tcPbs:j_id74:0:thursTime"]',"\b\b\b\b"+hours)
            .screenshot('11.png')
